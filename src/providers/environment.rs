...
mod tests {
    ...
    use crate::test_helpers::{limit, make_provider_request_with_env};
    ...
    async fn test_environment_suggests_with_prefix_for_pipe_target() {
        ...
        let req = make_provider_request_with_env("echo hi | synapse_p", "/tmp", env_hints).await;
    ...
    async fn test_environment_uses_path_from_env_hints() {
        ...
        let provider = EnvironmentProvider::new();
        let req = make_provider_request_with_env("synapse_only", "/tmp", env_hints).await;
    ...
    async fn test_environment_includes_virtual_env_bin() {
        ...
        let provider = EnvironmentProvider::new();
        let req = make_provider_request_with_env("synapse_from_v", "/tmp", env_hints).await;
    ...
    async fn test_environment_ignores_non_executable_files() {
        ...
        let provider = EnvironmentProvider::new();
        let req = make_provider_request_with_env("synapse_exec_", "/tmp", env_hints).await;
